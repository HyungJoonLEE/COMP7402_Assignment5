...
//
//
//void CBC::handleDES_CBC(User &u) {
//    if (u.getPtMode() == false) { } // TODO: process plain text
//    if (u.getPtMode() == false) { } // TODO: process plain text
//}
//
//
//bool CBC::isValidHex(const string& str) {
//    for (char c : str) {
//        if (!isxdigit(c)) {
//            return false;
//        }
...
//
//
//string CBC::getPTInput(const string& prompt) {
//    string input;
//    while (input.empty()) {
//        cout << prompt;
//        cin >> input;
...
//
//
//string CBC::hexCharToBin(char hexChar) {
//    switch(hexChar) {
//        case '0': return "0000";
//        case '1': return "0001";
//        case '2': return "0010";
...
//
//
//string CBC::hexToBin(const string& hexStr) {
//    string binStr = "";
...
//
//
//string CBC::binToHex(const string& binary) {
//    string hex;
...
//
//
//string CBC::decToBin(int decimal) {
//    string binary;
//
//    while(decimal != 0) {
...
//
//
//int CBC::binToDec(string binary) {
//    int decimal = 0;
//    int counter = 0;
...
//
//
//string CBC::shift_left_once(string key_chunk){
//    string shifted = "";
//
//    for(int i = 1; i < 28; i++){
//        shifted += key_chunk[i];
...
//
//
//string CBC::shift_left_twice(string key_chunk) {
//    string shifted = "";
//
//    for(int i = 0; i < 2; i++){
//        for(int j = 1; j < 28; j++){
...
//
//
//string CBC::Xor(string a, string b) {
//    string result = "";
//    int size = b.size();
//
...
//
//
//void CBC::generate_keys(string key) {
...
//
//
//string CBC::encryptECB(User &user){
//    // Initial permutation
//    string perm, txt;
...
//
//
//void CBC::appendToFile(const string& filename, const string& text) {
